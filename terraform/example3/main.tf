...
provider "aws" {
  ...
  //  assume_role {
  //    role_arn = "${var.role_arns_to_assume[var.role_type]}"
  //  }
}
...
//variable "role_type" {
//  description = "Which type of IAM role to use for these configurations"
//  default     = "readonly"
//}
//
//variable "role_arns_to_assume" {
//  description = "ARN of IAM role to assume by Terraform"
//  default = {
//    readonly = "arn:aws:iam::835367859851:role/demo-terraform-readonly"
//    admin = "arn:aws:iam::835367859851:role/demo-terraform-admin"
//  }
//
...
resource "aws_instance" "this" {
  ...
  key_name               = "anton"
  monitoring             = false
  vpc_security_group_ids = ["sg-76f18b0c"]
